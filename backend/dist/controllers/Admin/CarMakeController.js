    ...
    static add(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const addData = yield new CarMake_1.default(data).save();
                return ResponseHelper_1.default.created(res, "SUCCESS", "Add CarMake Successfully", data);
                // return _RS.ok(res, "SUCCESS", "List", { list: list }, startTime);
            }
            catch (err) {
                next(err);
    ...
    static edit(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const getData = yield CarMake_1.default.findOne({ _id: id });
                console.log(getData);
                if (!getData)
                    return ResponseHelper_1.default.notFound(res, "NOTFOUND", "CarMake not found", getData, startTime);
                // const data = {
                //   email: email,
    ...
    static statusChange(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const startTime = new Date().getTime();
                const id = req.params.id;
                const getData = yield CarMake_1.default.findOne({
                    _id: req.params.id,
                });
                if (!getData)
                    return ResponseHelper_1.default.notFound(res, "NOTFOUND", "CarMake not found", getData, startTime);
