    ...
    static list(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                var myAggregate = Voucher_1.default.aggregate(query);
                const list = yield Voucher_1.default.aggregatePaginate(myAggregate, options);
    ...
    static add(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const addData = yield new Voucher_1.default(data).save();
                return ResponseHelper_1.default.created(res, "SUCCESS", "Add Voucher Successfully", data);
    ...
    static edit(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const getData = yield Voucher_1.default.findOne({ _id: id });
                console.log(getData);
                if (!getData)
                    return ResponseHelper_1.default.notFound(res, "NOTFOUND", "Voucher not found", getData, startTime);
    ...
    static statusChange(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const startTime = new Date().getTime();
                const id = req.params.id;
                const getData = yield Voucher_1.default.findOne({
                    _id: req.params.id,
                });
                if (!getData)
                    return ResponseHelper_1.default.notFound(res, "NOTFOUND", "Voucher not found", getData, startTime);
