...
exports.GovermentController = void 0;
const User_1 = require("../../models/User");
const ResponseHelper_1 = require("../../helpers/ResponseHelper");
const Auth_1 = require("../../Utils/Auth");
const express = require("express");
class GovermentController {
    ...
    static addData(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (getData)
                    return ResponseHelper_1.default.conflict(res, "COFLICT", "Goverment already exist with this email ", getData, startTime);
                const data = {
                    email: email,
    ...
    static editData(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!getData)
                    return ResponseHelper_1.default.notFound(res, "NOTFOUND", "Goverment not found", getData, startTime);
                ...
                if (isCheck) {
                    return ResponseHelper_1.default.conflict(res, "CONFLICT", "Goverment already exists with this email or phone number", isCheck, startTime);
                }
...
exports.GovermentController = GovermentController;
