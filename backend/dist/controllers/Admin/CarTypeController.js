    ...
    static list(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                var myAggregate = CarType_1.default.aggregate(query);
                const list = yield CarType_1.default.aggregatePaginate(myAggregate, options);
    ...
    static add(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const addData = yield new CarType_1.default(data).save();
                return ResponseHelper_1.default.created(res, "SUCCESS", "Add CarType Successfully", data);
                // return _RS.ok(res, "SUCCESS", "List", { list: list }, startTime);
            }
            catch (err) {
                next(err);
    ...
    static edit(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const getData = yield CarType_1.default.findOne({ _id: id });
                console.log(getData);
                if (!getData)
                    return ResponseHelper_1.default.notFound(res, "NOTFOUND", "CarType not found", getData, startTime);
                // const data = {
                //   email: email,
    ...
    static statusChange(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const startTime = new Date().getTime();
                const id = req.params.id;
                const getData = yield CarType_1.default.findOne({
                    _id: req.params.id,
                });
                if (!getData)
                    return ResponseHelper_1.default.notFound(res, "NOTFOUND", "CarType not found", getData, startTime);
